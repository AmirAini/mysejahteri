...
if (password_verify($key,$pwHashed)== TRUE && $admin_name == "Amir"){
    echo "Welcome Admin";
} else {
    header('Location: ' . $_SERVER['HTTP_REFERER']);
    $_SESSION['status'] = "Password or Login Name Invalid";
}
...
<body class="app__card">
    ...
    <div class="app__container">
        <div class="app__cards_wrapper profile_active">
